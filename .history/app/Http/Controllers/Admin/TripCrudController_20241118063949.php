...
class TripCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        $this->crud->addField([
            ...
            'label' => 'Destination',
            'type' => 'select',
            'entity' => 'destination',  // Quan hệ giữa Trip và Destination
            'model' => 'App\Models\Destinations', // Model Destinations
            'attribute' => 'name', // Cột hiển thị trong dropdown
            'default' => 1, // Giá trị mặc định (nếu cần)
        ]);
