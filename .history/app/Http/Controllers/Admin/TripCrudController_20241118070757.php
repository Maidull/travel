...
class TripCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        $crud->addField([
            ...
            'label' => 'Destination',
            'type'  => 'select',
            'entity' => 'destination',  // Quan hệ với bảng destinations
            'model'  => 'App\Models\Destination',  // Mô hình Destination
            'attribute' => 'name',  // Hiển thị tên của destination trong dropdown
            'options'   => (function ($query) {
                return $query->orderBy('name', 'ASC')->get();  // Lấy tất cả destination đã sắp xếp theo tên
            }),
        ]);
